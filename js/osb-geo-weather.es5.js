...
(function () {
    ...
    var osbGeoWeather = (function (_HTMLElement) {
        _inherits(osbGeoWeather, _HTMLElement);

        function osbGeoWeather() {
            _classCallCheck(this, osbGeoWeather);

            _get(Object.getPrototypeOf(osbGeoWeather.prototype), 'constructor', this).apply(this, arguments);
        }

        // Register Element

        _createClass(osbGeoWeather, [{
            key: 'createdCallback',
            ...
            value: function updateForecastTemplate(data) {
                ...
                data.list.forEach(function (element, index, array) {
                    ...
                    templateHolder.innerHTML += '<li><h3>' + date.toDateString().slice(0, 3) + ' ' + date.getDate() + ' ' + date.toDateString().slice(4, 7) + '</h3><h4>' + element.weather[0].description + ' <i class="' + osbGeoWeather.prototype.getWeatherIcon(element.weather[0].description) + '"></i></h4></li>';
                });
            }
        }, {
            key: 'getLocation',
